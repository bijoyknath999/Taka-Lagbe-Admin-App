...
public class UserActivity extends AppCompatActivity {
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			final TextView totalClickTxt = (TextView) _view.findViewById(R.id.users_total_click_txt);
			final TextView applovinRevenueTxt = (TextView) _view.findViewById(R.id.users_applovin_revenue_txt);
			final TextView applovinRewardTxt = (TextView) _view.findViewById(R.id.users_applovin_reward_txt);
			final TextView applovinInterstitialTxt = (TextView) _view.findViewById(R.id.users_applovin_interstitial_txt);
			final TextView starappRewardTxt = (TextView) _view.findViewById(R.id.users_starapp_reward_txt);
			final TextView starappInterstitialTxt = (TextView) _view.findViewById(R.id.users_starapp_interstitial_txt);
			...
			textview2.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/google_sans.ttf"), Typeface.NORMAL);
			totalClickTxt.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/google_sans.ttf"), Typeface.NORMAL);
			applovinRevenueTxt.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/google_sans.ttf"), Typeface.NORMAL);
			...
			if (_data.get((int)_position).containsKey("uid")) {
				...
				if (_data.get((int)_position).containsKey("adminTotalClick")) {
					totalClickTxt.setText(_data.get((int)_position).get("adminTotalClick").toString());
				}
				if (_data.get((int)_position).containsKey("alRevenue")) {
					applovinRevenueTxt.setText(_data.get((int)_position).get("alRevenue").toString());
				}
				if (_data.get((int)_position).containsKey("alReward")) {
					applovinRewardTxt.setText("Reward : "+_data.get((int)_position).get("alReward").toString());
				}
				if (_data.get((int)_position).containsKey("alInterstitial")) {
					applovinInterstitialTxt.setText("Interstitial : "+_data.get((int)_position).get("alInterstitial").toString());
				}
				if (_data.get((int)_position).containsKey("starReward")) {
					starappRewardTxt.setText("Reward : "+_data.get((int)_position).get("starReward").toString());
				}
				if (_data.get((int)_position).containsKey("starInterstitial")) {
					starappInterstitialTxt.setText("Interstitial : "+_data.get((int)_position).get("starInterstitial").toString());
				}
